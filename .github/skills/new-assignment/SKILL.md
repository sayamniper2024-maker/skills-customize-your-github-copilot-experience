...
This skill contains metadata and instructions for the new assignment workflow.

## Description

Use this file to define the behavior, prompts, and reference mappings for the new assignment skill.
---
name: new-assignment
